...
public class S3ServiceImpl implements S3Service {
    ...
    public String uploadFile(PathName pathName, MultipartFile file) {
        ...
        String fileName = pathName.getPath() + "/" + UUID.randomUUID() + extractExtension(file.getOriginalFilename());
    ...
    private String getFileUrl(String fileName) {
        return String.format("https://%s.s3.ap-northeast-2.amazonaws.com/%s", s3Config.getBucket(), fileName);
    }
}